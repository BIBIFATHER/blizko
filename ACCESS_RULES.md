...
- Перед любым сохранением присылаю на проверку.

## Исключение
- Фиксации в ops‑логе/плане допускаются без отдельного “да”.
- Сохранение/фиксация результатов работы (документы/заметки) допускаются без отдельного “да”.
