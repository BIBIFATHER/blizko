...
## Preferred Skills Policy
- Сначала используй `Preferred Skills` выбранного агента
- Отходи от preferred skills только если задача явно требует другой метод
- Не подставляй случайные skills при наличии закреплённого набора
