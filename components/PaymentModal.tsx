        ...
        <div className="bg-[#6C2586] p-5 flex justify-between items-center text-white relative overflow-hidden">
          ...
          <div className="flex items-center gap-2 z-10">
            ...
            <div>
              ...
              <div className="text-[11px] text-white/80 font-medium">Business Module</div>
            </div>
          </div>
        ...
        <div className="p-6">
          ...
          <div className="flex bg-stone-100 p-1 rounded-xl mb-6">
            <button
              ...
              className={`flex-1 py-2.5 text-xs font-semibold rounded-lg transition-all flex items-center justify-center gap-2 ${method === 'sbp' ? 'bg-white text-stone-900 shadow-sm ring-1 ring-stone-200' : 'text-stone-500 hover:text-stone-700'
                }`}
            >
            ...
            <button
              ...
              className={`flex-1 py-2.5 text-xs font-semibold rounded-lg transition-all flex items-center justify-center gap-2 ${method === 'card' ? 'bg-white text-stone-900 shadow-sm ring-1 ring-stone-200' : 'text-stone-500 hover:text-stone-700'
                }`}
            >
