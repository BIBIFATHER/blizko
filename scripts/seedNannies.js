...
const nannies = [
  {
    ...
    about:
      'Высшее педагогическое образование. Работала в частном детском саду 5 лет и в двух семьях. Придерживаюсь гуманистического подхода, мягкая адаптация, чёткий режим дня.',
    ...
    documents: [
      {
        ...
        status: 'verified',
        aiConfidence: 99,
        aiNotes: 'Паспорт РФ, фото соответствует',
        verifiedAt: now,
      },
    ],
    softSkills: {
      rawScore: 92,
      dominantStyle: 'Structured',
      summary: 'Чётко соблюдает границы и режим, но проявляет высокую эмпатию к детям.',
      completedAt: now,
    },
    riskProfile: {
  ...
  },
  {
    ...
    about:
      'Врач-педиатр по образованию. Помогаю мамам с новорожденными, знаю всё о детском сне и прикорме. Могу выходить на ночь или на несколько часов днём, чтобы мама отдохнула.',
    ...
    softSkills: {
      ...
      summary: 'Спокойная, уверенная в себе, быстро реагирует на кризисные ситуации.',
      completedAt: now,
    },
    riskProfile: {
      emergencyReady: 'yes',
      tantrumFirstStep: 'calm',
      disciplineStyle: 'structured',
  ...
  },
  {
    ...
    about:
      'Студентка старших курсов МГЛУ. Отлично лажу со школьниками, помогаю с английским и домашкой. Увлекаюсь живописью, можем рисовать с ребёнком. Очень активная, любим гулять в парках.',
    ...
    softSkills: {
      ...
      summary:
        'Очень креативная, легко находит общий язык со старшими детьми, становится для них старшим другом.',
      completedAt: now,
    },
    riskProfile: {
      tantrumFirstStep: 'distract',
  ...
  },
  {
    ...
    about:
      'Работаю бебиситтером, пунктуальная, активная. Люблю читать детям книги и придумывать квесты на детских площадках. Считаю, что экранное время нужно сводить к минимуму.',
    ...
    softSkills: {
      rawScore: 80,
      dominantStyle: 'Balanced',
      summary: 'Легко адаптируется к новым условиям и быстро устанавливает контакт.',
      completedAt: now,
    },
    riskProfile: {
      tantrumFirstStep: 'calm',
  ...
  },
  {
    ...
    about:
      'Гувернантка премиум-класса. Музыкальное и педагогическое образование. Владею французским. Строгий, но сбалансированный режим, фокус на всестороннее развитие личности.',
    ...
    documents: [
      {
        ...
        status: 'verified',
        aiConfidence: 95,
        aiNotes: 'Рекомендации от 3 семей',
        verifiedAt: now,
      },
    ],
    softSkills: {
      rawScore: 98,
      dominantStyle: 'Structured',
      summary: 'Идеальная дисциплина, высокий уровень профессионализма в общении.',
      completedAt: now,
    },
    riskProfile: {
      emergencyReady: 'yes',
      tantrumFirstStep: 'boundaries',
      routineStyle: 'structured',
  ...
  },
  {
    ...
    about:
      'Забираю из школы/сада, везу на кружки, жду, отвожу домой, делаю уроки. Своя машина (комфорт-класс), автокресло. Спокойная, ответственная, сама мама двоих взрослых детей.',
    ...
    softSkills: {
      rawScore: 89,
      dominantStyle: 'Structured',
      summary: 'Высокая пунктуальность и ответственность на дорогах.',
      completedAt: now,
    },
    riskProfile: {
      emergencyReady: 'yes',
  ...
  },
  {
    ...
    about:
      'Добрая, чистоплотная. Обожаю готовить детскую еду. Полностью беру на себя быт (уборка, стирка, глажка) пока малыш спит. Люблю детей как своих.',
    ...
    softSkills: {
      rawScore: 78,
      dominantStyle: 'Empathetic',
      summary: 'Очень тёплая и заботливая, фокус на базовые потребности.',
      completedAt: now,
    },
    riskProfile: {
      tantrumFirstStep: 'distract',
  ...
  },
  {
    ...
    about:
      'Тренер по детскому плаванию и ЛФК. Идеальна для активных мальчишек — вымотаю на площадке так, что уснёт за минуту. Много энергии, современные взгляды на воспитание.',
    ...
    softSkills: {
      rawScore: 84,
      dominantStyle: 'Balanced',
      summary: 'Энергичная, умеет переводить агрессию в игру.',
      completedAt: now,
    },
    riskProfile: {
      tantrumFirstStep: 'distract',
  ...
  },
  {
    ...
    about:
      'Действующий логопед. Беру деток на запуск речи и постановку звуков. Играем в лого-игры, занимаемся артикуляционной гимнастикой. Параллельно гуляем и общаемся.',
    ...
    softSkills: {
      rawScore: 90,
      dominantStyle: 'Structured',
      summary: 'Чётко видит цель, системный подход.',
      completedAt: now,
    },
    riskProfile: {
      emergencyReady: 'yes',
  ...
  },
  {
    ...
    about:
      'Вырастила троих детей и четверых внуков. Для тех, кто ищет теплую и покладистую классическую бабушку малышу. Пеку пирожки, вяжу носки, пою колыбельные.',
    ...
    softSkills: {
      rawScore: 82,
      dominantStyle: 'Empathetic',
      summary: 'Максимальный уровень тепла и заботы, безусловное принятие.',
      completedAt: now,
    },
    riskProfile: {
      tantrumFirstStep: 'calm',
...
nannies[0].reviews = [
  {
    ...
    authorName: 'Анна С.',
    rating: 5,
    text: 'Елена прекрасная няня! Ребенок ее обожает.',
    date: now - 86400000,
  },
  {
    id: 'rev_2',
    authorName: 'Михаил',
    rating: 5,
    text: 'Очень ответственная, всегда вовремя.',
    date: now - 172800000,
  },
];
nannies[4].reviews = [
  {
    ...
    authorName: 'Семья В.',
    rating: 5,
    text: 'Нам очень повезло найти такую гувернантку. Дочь заговорила на французском через год.',
    date: now - 259200000,
  },
];
