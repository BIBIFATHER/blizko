        ...
        <div className="flex-1 overflow-y-auto no-scrollbar scroll-smooth">
          {slides.map((section, idx) => (
            ...
            >
              ...
              {section.icon && (
                <div
                  className="mb-6 self-center animate-fade-in"
                ...
                {section.type === 'steps' ? (
                  <div className="space-y-4 mt-2">
                    {section.steps?.map((step, sIdx) => (
                      <div
                        key={sIdx}
                        className="bg-white/70 backdrop-blur-sm p-4 rounded-xl border border-white/60 shadow-sm hover:shadow-md transition-shadow"
                      >
                        ...
                        <p className="text-xs text-stone-600 leading-relaxed pl-1">{step.desc}</p>
                      </div>
                    ))}
                  </div>
                ) : (
          ...
          <div className="p-8 bg-transparent pt-0">
            <Button onClick={onAction} pulse className="w-full text-lg">
