...
export const Home: React.FC<HomeProps> = ({ lang }) => {
  ...
  return (
    <>
      <div className="section-stack animate-fade-in pb-10 pt-6 md:pt-10">
            ...
            <div className="section-stack">
              <div className="section-stack max-w-[40rem]">
                ...
                <div className="section-stack gap-4">
                  <div className="text-[2.8rem] leading-[0.92] text-stone-900 font-display sm:text-[4rem]">
                    {lang === 'ru'
              ...
              <div className="hero-stat">
                <div className="grid grid-cols-3 gap-3 text-left">
                  ...
                  <div>
                    ...
                    <div className="mt-2 text-2xl font-semibold text-stone-900">{lang === 'ru' ? 'объяснимый' : 'explainable'}</div>
                  </div>
                </div>
              </div>
            </div>
