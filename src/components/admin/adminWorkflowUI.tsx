...
const AdminWorkflowUIContext = React.createContext<AdminWorkflowUIContextValue | null>(null);
      ...
      {confirmState && (
        <div className="fixed inset-0 z-[95] flex items-center justify-center bg-stone-900/55 p-4 backdrop-blur-sm">
          <div className={`${adminModalSurface} w-full max-w-md p-5`}>
            ...
            {confirmState.detail && (
              <p className="mt-2 text-xs leading-5 text-stone-500 whitespace-pre-line">
                {confirmState.detail}
              </p>
            )}
      ...
      {promptState && (
        <div className="fixed inset-0 z-[95] flex items-center justify-center bg-stone-900/55 p-4 backdrop-blur-sm">
          <div className={`${adminModalSurface} w-full max-w-lg p-5`}>
            ...
            {promptError && (
              <div className="mt-2 text-xs font-medium text-red-600">{promptError}</div>
            )}
            <div className="mt-5 flex gap-2">
              <Button
                className="w-auto px-5"
