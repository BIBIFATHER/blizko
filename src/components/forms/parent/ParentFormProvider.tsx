...
export const ParentFormProvider: React.FC<{
  ...
  const [riskProfile, setRiskProfile] = useState<ParentRequest['riskProfile']>({
    ...
    familyStyle: initialData?.riskProfile?.familyStyle,
    homeRhythm: initialData?.riskProfile?.homeRhythm,
    adaptationStyle: initialData?.riskProfile?.adaptationStyle,
    boundaryStyle: initialData?.riskProfile?.boundaryStyle,
    parentAnxiety: initialData?.riskProfile?.parentAnxiety,
    decisionStyle: initialData?.riskProfile?.decisionStyle,
    childStress: initialData?.riskProfile?.childStress,
    triggers: initialData?.riskProfile?.triggers || [],
    nannyStylePreference: initialData?.riskProfile?.nannyStylePreference || 'gentle',
    communicationPreference: initialData?.riskProfile?.communicationPreference,
