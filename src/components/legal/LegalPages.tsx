      ...
      <article className="page-frame section-stack animate-fade-in py-4 pb-16 md:py-8">
        ...
        <div className="space-y-6 text-sm text-stone-700 leading-relaxed">
          ...
          <section className="section-shell p-5">
            ...
            <p className="mt-2">
              Оплата производится через платёжный сервис T-Bank Касса (АО «Тинькофф Банк»). Blizko
              использует сервис «Безопасная сделка» для защиты платежей: средства зачисляются и
              удерживаются до подтверждения факта оказания услуги.
            </p>
          </section>
