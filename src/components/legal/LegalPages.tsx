            ...
            <article className="page-frame section-stack animate-fade-in py-4 pb-16 md:py-8">
                ...
                <div className="space-y-6 text-sm text-stone-700 leading-relaxed">
                    <section className="section-shell p-5">
                        ...
                        <p>Настоящая оферта является официальным предложением ИП Аносов Антон Владимирович (ОГРНИП 324344300006654, ИНН 710513782849, далее — «Blizko», «Исполнитель») заключить договор на оказание информационно-посреднических услуг по подбору персонала (нянь) на условиях, изложенных ниже.</p>
                ...
                <div className="space-y-4">
                    <div className="section-shell p-5">
                        ...
                        <p className="text-sm text-stone-600 leading-relaxed">
                            Blizko — платформа для более спокойного подбора нянь в Москве. Мы используем цифровые инструменты и ручную модерацию, чтобы семье было легче перейти от тревожного поиска к 2–3 подходящим вариантам.
                        </p>
                    ...
                    <div className="section-shell p-5">
                        ...
                        <div className="text-sm text-stone-600 space-y-3">
                            <div>
                                ...
                                <p>2–3 подходящих няни с модерацией профилей и объяснением выбора. Разовая оплата.</p>
                            </div>
                            <div>
            ...
            <article className="page-frame section-stack animate-fade-in py-4 pb-16 md:py-8">
                ...
                <div className="space-y-4 text-sm text-stone-700 leading-relaxed">
                    <div className="section-shell p-5">
                        ...
                        <p>ИП Аносов Антон Владимирович (ОГРНИП 324344300006654, далее — Blizko) является оператором персональных данных в соответствии с ФЗ-152 «О персональных данных».</p>
                    </div>
