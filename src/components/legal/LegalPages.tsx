        ...
        <div className="space-y-4 text-sm text-stone-700 leading-relaxed">
          ...
          <div className="section-shell p-5">
            ...
            <p className="mt-2">
              ...
              аккаунта персональные данные уничтожаются в течение 30 дней, за исключением
              финансовых документов, которые хранятся 5 лет согласно требованиям бухгалтерского
              учёта (ФЗ-402).
            </p>
          </div>
          ...
          <div className="section-shell p-5">
            ...
            <p className="mt-2">
              Удалить аккаунт и все данные можно самостоятельно в разделе «Профиль» приложения.
              Для иных запросов напишите на{' '}
              <a href="mailto:support@blizko.app" className="text-amber-600 underline">
                support@blizko.app
              </a>
