...
export const HowWeVerifyPage: React.FC = () => {
    ...
    const steps = useMemo(() => [
        ...
        },
        {
            ...
            description: 'Мы сопоставляем возраст детей, график, опыт и стиль общения и объясняем, почему именно эта няня подошла.',
        },
    ], []);
...
const humanityPlusSchema = {
    ...
    mainEntity: [
        ...
        {
            '@type': 'Question',
            name: 'Кто принимает решение — AI или куратор?',
            acceptedAnswer: {
                '@type': 'Answer',
                text: 'Финальное решение принимает куратор вместе с семьёй. AI помогает структурировать информацию, подсветить совпадения и не потерять важные детали, но не заменяет человеческую оценку.',
            },
        },
        {
            '@type': 'Question',
...
export const HumanityPlusPage: React.FC = () => {
    ...
    const factors = useMemo(() => [
        { emoji: '🧩', title: 'Контекст семьи', description: 'Возраст ребёнка, график, пожелания и тревоги родителей — с этого начинается подбор.' },
        { emoji: '🛡️', title: 'Проверка и документы', description: 'Анкеты проходят модерацию, документы — проверку. Что уже видно — видно заранее.' },
        { emoji: '👩‍🍼', title: 'Опыт няни', description: 'Смотрим на реальный опыт и навыки под ваш запрос, а не просто на доступность.' },
        { emoji: '🧑‍💼', title: 'Решение куратора', description: 'Финальный выбор — за куратором вместе с семьёй. AI помогает не потерять важные детали.' },
        { emoji: '📈', title: 'Точнее со временем', description: 'По мере работы платформа учитывает обратную связь после встреч — подбор уточняется.' },
    ], []);
            ...
            <article className="page-frame section-stack animate-fade-in py-4 pb-16 md:py-8">
                ...
                <header className="hero-shell">
                    <div className="section-stack">
                        ...
                        <p className="section-body">Мы соединяем человеческую экспертизу куратора и систему доверительных сигналов, чтобы семья получила не случайный список анкет, а несколько понятных и проверенных вариантов.</p>
                    </div>
                </header>
                ...
                <section className="section-shell p-6">
                    ...
                    <ol className="space-y-2 text-sm text-stone-600 list-decimal list-inside leading-7">
                        ...
                        <li>Куратор собирает контекст, анкеты, документы и опыт — AI помогает структурировать и подсветить совпадения</li>
