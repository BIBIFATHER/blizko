...
export const t = {
  ru: {
    ...
    heroSubtitle:
      'Blizko помогает пройти путь от тревожного поиска к нескольким понятным вариантам — с модерацией, сигналами доверия и объяснением, почему именно они подошли вашей семье.',
    homeProofChips: [
...
4. Сверяем наблюдаемые сигналы вручную и используем ИИ как вспомогательный инструмент, а не как финальный суд.
Это не даёт абсолютных гарантий, но помогает семье быстрее понять, что стоит обсудить до первого выхода.`,
    ...
    parentEtaLine: 'Куратор получит заявку и выйдет на связь в течение 24 часов.',
    ...
    verificationDesc:
      'Когда этот шаг доступен, подтверждение личности добавляет профилю дополнительный сигнал доверия.',
    ...
    successDesc: 'Заявка передана куратору. Он свяжется с вами в течение 24 часов.',
    successNextCta: 'Перейти в личный кабинет',
    successEditCta: 'Изменить заявку',
    aiMatch: 'ИИ-анализ совместимости',
    probability: 'вероятность успеха',
    recsTitle: 'Варианты от куратора:',
    returnHome: 'Вернуться на главную',
    successAnalyzingTitle: 'Анализируем профиль...',
    successMatchingTitle: 'Готовим варианты...',
    successProcessingNote: 'Проверяем заявку...',
...
This does not create absolute guarantees, but it helps the family see what should be discussed before the first shift.`,
    ...
    parentEtaLine: 'Your curator will receive the request and reach out within 24 hours.',
    ...
    successDesc: 'Request sent to your curator. They will reach out within 24 hours.',
    ...
    recsTitle: 'Options from your curator:',
    returnHome: 'Return to Home',
    successAnalyzingTitle: 'Analyzing the profile...',
    successMatchingTitle: 'Preparing your options...',
    successProcessingNote: 'Reviewing your request...',
