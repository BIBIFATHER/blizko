...
“Близко” заботится о том, чтобы к вашему ребёнку приходили только проверенные и ответственные люди.`,
    ...
    reqOptions: ['Опыт с младенцами', 'Мягкий подход (без критики)', 'Развивающие методики', 'Готовка для ребенка', 'Долгие прогулки'],
...
"Blizko" ensures only vetted and responsible people come to your child.`,
    ...
    reqOptions: ['Infant experience', 'Gentle approach', 'Developmental methods', 'Cooking for child', 'Long walks'],
