...
export const t = {
  ru: {
    ...
    heroSubtitle: 'Blizko помогает пройти путь от тревожного поиска к нескольким понятным вариантам — с модерацией, trust-сигналами и объяснением, почему именно они попали в shortlist.',
    homeProofChips: ['Не каталог из десятков анкет', 'Понятные причины, почему подходит', 'Один процесс: запрос, shortlist, следующий шаг'],
...
Это не даёт абсолютных гарантий, но помогает семье быстрее понять, что стоит обсудить до первого выхода.`,
    ...
    explainBadge4: '',
    shortlistHeroTitle: 'Не бесконечный поиск, а понятный shortlist',
    shortlistHeroSubtitle: 'Мы оставили только те профили, где можно быстрее перейти к разговору о деталях, а не тратить силы на хаотичный просмотр анкет.',
    shortlistReasonTitle: 'Почему кандидат попал в shortlist',
    shortlistTrustTitle: 'Что уже видно заранее',
    shortlistRiskTitle: 'Что обсудить до первого выхода',
    shortlistEmptyTitle: 'Пока кандидатов нет',
    shortlistEmptyDesc: 'Мы расширяем поиск. Попробуйте скорректировать бюджет или график.',
    shortlistFooter: 'Напишите няне, обсудите shortlist в семье и двигайтесь к следующему шагу без лишнего хаоса.',
    profileSelectedLabel: 'Профиль из shortlist',
    profileOpenWhyTitle: 'Почему профиль стоит открыть',
    profileOpenWhyBody: 'Сначала видно базовые сигналы доверия, затем стиль общения и только потом детали анкеты. Так проще понять, подходит ли человек вашей семье.',
    profileReviewsTitle: 'Отзывы',
    profileReviewsBody: 'Это один из самых понятных trust-сигналов после модерации профиля.',
    profileDetailsToggle: 'Подробнее о няне',
    profileDetailsHide: 'Скрыть подробности',
    profileAboutTitle: 'О няне',
    profileStyleTitle: 'Стиль работы с детьми',
    profileSkillsTitle: 'Навыки',
    profileAgesTitle: 'Возраст детей',
    ...
    agesLabel: 'С каким возрастом работали?',
    skillsLabel: 'Ваши навыки',
    ...
    videoRecorded: 'Визитка записана',
    videoModalTitle: 'Видеоинтервью',
    videoModalHint: 'Расскажите, почему вы любите работать с детьми.',
    ...
    authSubtitle: 'Управляйте анкетами и подпиской',
    ...
    tabProfile: 'Профиль',
    tabBookings: 'Заказы',
    activeBookingTitle: 'Активный заказ',
    historyTitle: 'История',
    chatWithNanny: 'Чат с няней',
    openChat: 'Открыть чат',
    statusActive: 'Активен',
    statusCompleted: 'Завершен',
    statusCancelled: 'Отменен',
    nannyChatPlaceholder: 'Написать няне...',
    ...
    offerTabPrivacy: 'Перс. данные',
    offerAccept: 'Я принимаю условия сотрудничества',
    offerPrivacyAccept: 'Я согласна на обработку персональных данных',
    offerSubmit: 'Подтвердить и отправить',
    offerText: [
      'Я подтверждаю, что понимаю и принимаю следующие условия:',
      'Платформа «Близко» не является моим работодателем и не несёт ответственности за мои действия.',
      ...
      '• не применять лекарственные средства без письменного согласия родителей;',
    ...
    nannyPersonalDataText: [
      ...
      '1. Я даю свое согласие платформе «Близко» на обработку моих персональных данных, включая сбор, запись, систематизацию, накопление, хранение, уточнение, извлечение, использование, передачу (распространение, предоставление, доступ), обезличивание, блокирование, удаление, уничтожение.',
    ...
    parentOfferTitle: 'Пользовательское соглашение',
    parentOfferTabTerms: 'Правила',
    parentOfferTabPrivacy: 'Перс. данные',
    parentOfferAccept: 'Я принимаю условия использования платформы',
    parentOfferPrivacyAccept: 'Я согласен(на) на обработку персональных данных',
    parentOfferSubmit: 'Подтвердить и найти няню',
    parentOfferText: [
      'Я подтверждаю, что понимаю и принимаю следующие условия:',
      'Платформа «Близко»:',
      '• осуществляет подбор и проверку нянь;',
      '• не оказывает услуги по уходу за ребёнком;',
      '• не является стороной договора между мной и няней.',
      'Все решения о сотрудничестве с няней я принимаю самостоятельно.',
      'AI-проверка и анкеты:',
      '• помогают оценить надёжность и совместимость;',
      '• не являются гарантией поведения няни.',
      'Я согласен(на), что:',
    ...
    parentPersonalDataText: [
      ...
      '1. Я даю свое согласие платформе «Близко» на обработку моих персональных данных.',
    ...
    chatWelcome: 'Здравствуйте! Я Анна, менеджер заботы. Чем я могу помочь?',
    chatSend: 'Отпр.',
  ...
  en: {
    ...
    heroSubtitle: 'Blizko helps families move from anxious searching to a few clear options — with moderation, trust signals, and an explanation of why each one made the shortlist.',
    homeProofChips: ['Not a catalog of dozens of profiles', 'Clear reasons why someone fits', 'One process: request, shortlist, next step'],
...
This does not create absolute guarantees, but it helps the family see what should be discussed before the first shift.`,
    ...
    shortlistHeroTitle: 'Not an endless search, but a clear shortlist',
    shortlistHeroSubtitle: 'We kept only the profiles that make it easier to move into a real conversation instead of spending energy on chaotic browsing.',
    shortlistReasonTitle: 'Why someone made the shortlist',
    shortlistTrustTitle: 'What is already visible',
    shortlistRiskTitle: 'What to discuss before the first shift',
    shortlistEmptyTitle: 'No candidates yet',
    shortlistEmptyDesc: 'We are widening the search. Try adjusting your budget or schedule.',
    shortlistFooter: 'Message the nanny, discuss the shortlist with your family, and move to the next step without extra chaos.',
    profileSelectedLabel: 'Profile from the shortlist',
    profileOpenWhyTitle: 'Why open this profile',
    profileOpenWhyBody: 'Trust signals come first, then communication style, then deeper details. That makes it easier to understand whether this person fits your family.',
    profileReviewsTitle: 'Reviews',
    profileReviewsBody: 'This is one of the clearest trust signals after moderation.',
    profileDetailsToggle: 'More about this nanny',
    profileDetailsHide: 'Hide details',
    profileAboutTitle: 'About the nanny',
    profileStyleTitle: 'Work style with children',
    profileSkillsTitle: 'Skills',
    profileAgesTitle: 'Child ages',

    // Install App
    installTitle: 'Install Blizko',
    installDesc: 'Add app to home screen for quick access.',
    installBtn: 'Install',

    // Parent Form
    back: 'Back',
    pFormTitle: 'Find a Nanny',
    pFormSubtitle: 'Describe your ideal nanny',
    cityLabel: 'City and District',
    childAgeLabel: "Child's Age",
    scheduleLabel: 'Schedule',
    budgetLabel: 'Budget (hourly or salary)',
    ...
    nFormSubtitle: 'Tell us about yourself to find a family',
    ...
    agesLabel: 'Ages worked with?',
    skillsLabel: 'Your Skills',
    aboutLabel: 'About yourself (a few sentences)',
    contactLabel: 'Phone or Email',
    submitNanny: 'Submit Profile',

    // Photo
    photoTitle: 'Your Photo',
    photoDesc: 'Upload a kind, bright photo. Parents choose with their eyes.',
    ...
    reviewChecklistLabel: 'What mattered most?',
    reviewChecklistOptions: ['Punctuality', 'Care', 'Safety', 'Communication', 'Initiative'],
    reviewPreviewLabel: 'Review preview',
    ...
    scanSuccess: 'Document Verified',
    scanConfidence: 'AI Confidence',

    // Video Interview
    videoTitle: 'Video Intro',
    videoDesc: 'Record a short greeting (30 sec). This increases trust by 80%.',
    recordVideo: 'Record Video',
    videoRecorded: 'Video Recorded',
    videoModalTitle: 'Video Interview',
    videoModalHint: 'Tell us why you love working with children.',
    ...
    sectionReflect: 'Part 3: Self-Reflection',
    ...
    authSubtitle: 'Manage profiles and subscription',
    ...
    shareTitle: 'Open on Phone',
    shareDesc: 'Scan the code with your camera to open and install the app.',

    // Auth Roles
    roleParent: 'I am a Parent',
    roleNanny: 'I am a Nanny',

    // Nanny Dashboard
    nannyDashTitle: 'Nanny Cabinet',
    ...
    chatWithNanny: 'Chat with Nanny',
    openChat: 'Open Chat',
    statusActive: 'Active',
    statusCompleted: 'Completed',
    statusCancelled: 'Cancelled',
    nannyChatPlaceholder: 'Message nanny...',
    payForBooking: 'Pay',
    paidStatus: 'Paid',
    ...
    offerTabTerms: 'Terms',
    offerTabPrivacy: 'Privacy',
    offerAccept: 'I accept the terms of cooperation',
    offerPrivacyAccept: 'I agree to the processing of personal data',
    offerSubmit: 'Confirm & Submit',
    offerText: [
      'I confirm that I understand and accept the following conditions:',
      'The "Blizko" platform is not my employer and is not responsible for my actions.',
    ...
    nannyPersonalDataText: [
      ...
      '1. I give my consent to the "Blizko" platform to process my personal data, including collection, recording, storage, use, and transfer.',
    ...
    // Parent Offer / Agreement
    parentOfferTitle: 'Terms of Use',
    parentOfferTabTerms: 'Rules',
    parentOfferTabPrivacy: 'Privacy',
    parentOfferAccept: 'I accept the terms of use',
    parentOfferPrivacyAccept: 'I agree to the processing of personal data',
    parentOfferSubmit: 'Confirm & Find Nanny',
    parentOfferText: [
      'I confirm that I understand and accept the following conditions:',
      'Platform "Blizko":',
      '• carries out selection and verification of nannies;',
      '• does not provide childcare services;',
      '• is not a party to the contract between me and the nanny.',
    ...
    parentPersonalDataText: [
      ...
      '1. I give my consent to the "Blizko" platform to process my personal data.',
